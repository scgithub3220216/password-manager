...
<template>
  <div>
    <div style="position: relative">
      <el-button type="primary" :disabled="resetDisabled" @click="reset" style="position: absolute;left: 220px">重置</el-button>
      <el-button type="primary" :disabled="saveButtonDisabled" @click="saveShortcuts" style="position: absolute;left: 280px">保存</el-button>
    </div>
